...
import com.demo.core.plugin.de.domain.FormRecordEntryBean;
 ...
 */
@Repository
public interface FormRecordEntryBeanRepository extends CrudRepository<FormRecordEntryBean, Long>{
	FormRecordEntryBean findByFormCtxtIdAndObjectIdAndRecordId(Long formCtxtId, Long objectId, Long recordId);
	@Query("select " + 
			"        re " + 
			"      from " + 
			"        com.demo.core.plugin.de.domain.FormRecordEntryBean re" + 
			"        join re.formCtxt fc" + 
			"      where " + 
